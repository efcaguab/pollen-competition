...
broom::tidy(facilitation_models, conf.int = F) %>%
  ...
  knitr::kable(caption = "Summary of the model used to analyse the relationship of heterospecific and conspecific pollen", 
               digits = 3,
               booktabs = T,
...
tbl_frame %>%
  knitr::kable("latex", 
               ...
               caption = "Slope of the relationship of heterospecific and conspecific pollen for each species in their community (fixed effect + conditional effect). Community names are constructed by location - agricultural/restored - fragment number.", 
               booktabs = T, 
               linesep = "") %>%
  kableExtra::kable_styling(font_size = 8) %>%
