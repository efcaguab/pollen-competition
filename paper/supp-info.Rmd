...
```{r fig-model-results, fig.height = 9, fig.cap = "Distribution of effect estimates for models of conspecific and heterospecific pollen density gain. Model formulas have been abbreviated: *a* for abundance, *k* for the number of shared polinators, *p* for the visit effectiveness, and *t* for trait originality.", eval=T}
