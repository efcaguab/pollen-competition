...
```{r fig-conspecififc-heterospecific, fig.height=2, fig.width = 3.57, fig.cap="Despite the variation in these slopes, plants overall had more conspecific than heterospecific pollen deposited in their stigmas."}
