...
model_formula_ranking$by_model_set %>% 
  ...
  knitr::kable("latex", 
               caption = paste('Comparison of the different fixed structures we considered. The table shows median delta AIC values of', dplyr::n_distinct(glanced_random$model), "bootsrap resamples of the data. The 5th and 95th percentile are shown inside square brackets."),
               booktabs = TRUE) %>%
  kableExtra::kable_styling(font_size = 8) %>%
