...
broom::tidy(facilitation_models, conf.int = F) %>%
  ...
  knitr::kable(caption = "Summary of the model used to analyse the relationship between heterospecific and conspecific pollen", 
               digits = 3,
               booktabs = T,
...
broom::tidy(open_bagged_model, conf.int = F) %>%
  ...
  knitr::kable(caption = "Summary of the model used to analyse the relationship between conspecific pollen deposited in bagged and unbagged flowers (open to animal pollination).", 
               digits = 3,
               booktabs = T,
               col.names = c("predictor", "estimate" ,"S.E.", "z-value")) %>%
  kableExtra::kable_styling(font_size = 8) %>%
