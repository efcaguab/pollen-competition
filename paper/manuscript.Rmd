...
* Introduction has been rewritten to be more *hypothesis* oriented. The manuscript also includes references throughout.
* Added abstract

### To do

* Spell-check everything
* Decide on a journal. The manuscript is currently written for an interdisciplinary one. 
