...
At the community scale, competition for pollination might arrise from changes in the quantity and quality of pollination. 
Quantity is mainly affected by competition for visits, where plants with more atractive flowers reduce the number of visits for those less atractive and therefore they may experience a reduction in the amount of conspecific pollen received. 
Quality is mainly affected by a more subtle but perhaps more important mechanism—interspecific pollen transfer, where even receiving a visit might not translate into net facilitation. 
This is so because focal plant might receive pollen from a different species, or conversely pollen from the focal plant might be lost to different species. 
...
Only a handful of studies have examined interspecific pollen transfer at the community level, and therefore we still understand little about how compeition for pollinators operates at this scale. 
All together, existing studies at the community scale show that, as expected, the effective result of mutualistic interactions is, in most cases, one of facilitation. 
...
One of the most intuitive drivers of this variability, and therefore widely used in theoretical models of mutualism to account for the neggative effects of mutualism is the species degree---the number of mutualistic partners. 
...
Recent empirical evidence suggest that other factors might also play an important role shaping the competition for pollination. 
For instance, species with original traits (far from the community centroid) have been shown to generally have fewer interaction partners. 
...
Similarly, it might also be the case that density is the dominant force driving pollen transfer. 
