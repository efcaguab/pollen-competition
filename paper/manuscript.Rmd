...
* Format taylored for submission to Ecology Letters
...
<!-- Altogether, multiple, potentially correlated, factors may act simultaneously.  -->
 <!-- factors (number of shared pollinators, traits, abundance, visitation patterns) -->
Altogether, it is clear that some ecological factors can influence pollen deposition. 
<!-- We can think on , hence, together may carry enough information to roughly define the species *realised niche* in the context of competition for pollination.  -->
...
**Second**, we investigate the relative contribution that four ecological factors have on competition for pollination. 
These factors, in the specific context of pollination, may carry enough information to roughly define a species *realised niche* in their community. 
...
However, we also hypothesize that other factors like the plant's functional originality, its relative abundance, and the visit effectiveness should have the potential to compensate for this increase in competition by improving either the quality or the quality of pollination. 
**Third**, we examine how community context influences the way plants use these factors to minimise competition. 
Although some plant species might be widespread across multiple locations, competition for pollinators occurs at the community level and hence we predict niche to be influenced by the local context. 
If plant strategy is not flexible across communities, we could expect niches to be more similar within species than across species in the study. 
...
In contrast, the opposite pattern may indicate that plants benefit from animal-mediated pollination---even a small difference between outcross and self-pollen may be important to plant fitness. 
<!-- FDO: Asked coauthors for a reference for the previous statement and no-one provided feedback, so removing it -->
