...
Specifically, we hypothesize that the quantity and purity of cospecific pollen deposition should decreasse for plants that share many pollination partners
...
Our second objective was to investigate the relative contribution that different eological factors have on the mechanisms of pollinator-mediated competition. 
Generally speaking,
...
Finally, we scaled all foyr factors to have a zero mean and unitary variance.
...
To test this, we first used a principal component analysis (PCA) of the four ecological factors (number of shared pollinators, floral abundance, visit effectiveness, and trait originality). 
...
We then examined the potential roles played by four ecological factors (number of shared pollinators, abundance, mean visit effectiveness, and functional originality). 
...
Of the four factors we considered, we found that a plant's mean visit effectiveness and realtive floral abundance were the most important at predicting pollen deposition in plant stigmas (Figure \@ref(fig:fig-average-qual-quant)a). 
...
Nevertheless, our results indicate that the strategies that plant might use to successfully minimise competition for pollination (or maximise facilitation) must be determined relative to other species in the community, rather than an absolute property of the species itself. 
