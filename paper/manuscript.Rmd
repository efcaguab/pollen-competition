...
**Number of words:** `r readd(abs_wordcount)$n_words_stri` in the abstract; `r format(round(readd(msc_wordcount)$n_words_stri/10)*10, big.mark = ",")` in the main text.

**Number of displays:** `r readd(n_displays)$figures` figures; `r readd(n_displays)$tables` tables; `r readd(n_displays)$text_boxes` text boxes.

**Number of references:** `r readd(n_references)`

**Author for correspondence:** E. Fernando Cagua (efc29@uclive.ac.nz) - +64 20 4026 8153

**Authors' email addresses:** Hugo J. Marrrero (hugomarrero@gmail.com); Jason M. Tylianakis (jason.tylianakis@canterbury.ac.nz); Daniel B. Stouffer (daniel.stouffer@canterbury.ac.nz)
