...
<!-- DBS: Fer, please check my edit above to make sure it's correct. -->
...
Of the four variables we considered, we found that a plant's mean visit effectiveness and realtive abundance were the most important ecological variables predicting pollen deposition in plant stigmas (Figure \@ref(fig:fig-average-qual-quant)a). 
...
This indicates that, although there is a positive association between visit effectiveness and the quantity pollen deposition, there is a negative relationship with its purity (Figure \@ref(fig:fig-average-qual-quant)c). 
In contrast, a plants' relative abundance had a negative effect on the pollen deposition quantity, but the mean difference between the coefficients in the models indicates a positive association with the purity (Figure \@ref(fig:fig-average-qual-quant)c). 
...
We used a PCA of the analysed species to investigate whether plants' realised niches of competition for pollination is similar across communities or whether they are flexible and therefore a reflection of the community context. 
