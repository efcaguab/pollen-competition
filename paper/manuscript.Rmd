...
Alternatively, if the community plays a significant role and plant species are flexible, we should be able to observe differences in the pollination niche a plant species occupies across communities. 
...
We define a species' pollination niche in a community as its coordinates in PCA space. 
For each species that was present in two or more communities, we then calculated (*i*) the median distance between the points that correspond to the niches species occupies in different communities and (*ii*) the area of the convex hull defined by these points in the first two principal components (only for species present in three or more communities). 
