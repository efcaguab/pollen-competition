...
Specifically, having high functional originality relative to other species in the community or sharing few pollinators is benetitial to both the quantity and quality of pollination.
Interestingly, these two strategies also had lower explanatory power in the models of pollen deposition. 
This is not to say that these variables are actually unimportant to pollen deposition, rather it suggest that the processes that underlay them might be more complex than what our metrics are able to capture. 
Especially in what relates to conspecific pollen deposition, which was harder to model than heterospecific pollen. 
