...
**Manuscript length:** `r format(msc_wordcount$n_char_tot_stri, big.mark = ",")` characters, approx. `r format(round(msc_wordcount$n_words_stri/10)*10-340, big.mark = ",")` words (includes draft info, excludes front-matter, abstract, awknoledgements, references, and figure/table legends); `r msc_wordcount$reading_time_stri` reading time.
