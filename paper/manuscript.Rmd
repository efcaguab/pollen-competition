...
However, their relative importance and **the trade-offs** that exist between them has not been determined. 

Here, we investigate pollen transfer dynamics at the community scale using empirical data from eleven plant-pollinator communities in the Argentinian Pampas. 
First, we investigate the relative contribution that four ecological factors have to the pollination service. 
Specifically, we hypothesize that there are trade offs on how these factors affect quantity and purity of conspecific pollen deposition. 
While quantity and putity should decrease for plants that share many pollination partners, other factors like the plant's functional originality, its relative floral abundance, and its visitation patterns should have the potential to compensate for this decreasse
Second, once we understand how these factors operate across species, we examine wether species show similar patterns in these four factors across the different communities where they are present. 
