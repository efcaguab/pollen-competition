...
In the short term, being a specialist and sharing no pollinators might reduce competition [@muchhala_competition_2010] and hence be preferable, as we show that sharing pollinators reduces conspecific pollen deposition both in absoluate terms and relative to heterospecific pollen. 
...
Visit effectiveness (high pollen and visits) and abundance, which were the most important predictors of pollen deposition, involved an even more explicit trade-off between conspecific and heterospecific pollen. 
On the one hand, receiving high visitation increases the absolute levels of conspecific pollen deposition but increases heterospecific deposition to a greater extent---even when the visitors are likely to carry a high proportion of conspecific pollen. 
On the other, being abundant reduces the amount of heterospecific pollen deposited but at the expense of a noticeable reduction in the amount of conspecific pollen. 
...
The strong contribution of the random effects in our models suggest that the effects of pollen deposition can vary greatly among species. 
For instance, for some plant species even low amounts of heterospecific pollen deposition can have a large impact on fitness while other species might be instead limited by the amount of conspecific pollen deposited by animal pollination [@campbell_mechanism_1985; @arceo-gomez_interactive_2019]. 
Similarly, plant species can also differ on the extent to which self- vs. outcross-pollen differ in their value for fertilization. 
For species that are not self-fertile or those in which self-fertilization is rarely effective due to a temporary separation in the maturation of the sexes (dichogamy), even 
Wether some patterns indicate facilitation or competition might 

Beyond species identity, however we show that the way plants balance the costs and benefits of sharing pollinators, beyond species identity, is strongly determined by the community it belongs to.

Different species balance the costs and benefits differently as the effects of conspecific and 
Here we also show that  
Na
<!-- The mechanisms through which sharing pollinators may induce net competition are relatively well understood.  -->
<!-- It can occurr for example, when a more dominant species, monopolizes a limited number of pollinators [@mitchell_new_2009; @lopezaraizamikel_impact_2007], when heterospecific pollen deposited in the stigma phisically interferes with deposition of conspecific pollen [@runquist_pollinator-mediated_2012], or when conspecific pollen is lost to heterospecific stigmas [@mitchell_new_2009; @muchhala_interspecific_2012].  -->
...
Extra potential refs:
https://besjournals.onlinelibrary.wiley.com/doi/pdf/10.1111/1365-2745.12256
https://academic.oup.com/aob/article/118/2/249/1741474
https://www.jstor.org/stable/3547899?seq=1#metadata_info_tab_contents
https://onlinelibrary.wiley.com/doi/full/10.1111/ele.12342
