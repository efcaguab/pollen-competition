...
Alongside the direct benefits of mutualisms between plants and their pollinators, biodiversity can be supported as a result of the inter-species "facilitation"—the indirect positive feedback loops that exist between plant species that share pollinators or pollinators that share plants [@moeller_facilitative_2004; @ghazoul_floral_2006; @molina-montenegro_positive_2008; @liao_presence_2011]. 
...
However, it is less clear how exactly ecological differentiation, in turn, affects the trade-off between facilitation and competition that is involved in the pollination service.
<!-- DBS; The end of the sentence above is confusing. Is it because what you mean by "the pollination service" hasn't been made explicit yet? -->
...
<!-- DBS: The above should be interspecific, no? -->
...
However, with few exceptions [@rathcke_interactions_1988; @lopezaraiza-mikel_impact_2007; @tur_evaluating_2016; @hegland_relative_2009; @aizen_reproductive_2010], most of what we know about the deposition of conspecific and heterospecific pollen---and its relationship to competition vs. facilitation in pollination communities---is based on studies with two plant species. 
...
<!-- DBS: Fer, I absolutely love this sentence. -->
...
This evidence is aligned with the notion that a species that interacts with few species does so strongly with each of them whereas a species that interacts with a large number of species does so comparatively weakly\R{ref-interaction-strength}. 
<!-- DBS: Doesn't Bascompte et al 2006 Science show this? Or maybe Thébault and Fontaine 2008 Oikos? -->
...
<!-- DBS: I feel like the paragraph starts to lose the plot in the bit that follows. Where did realised niche come from and why invoke it? -->
...
On the other hand, we could expect a larger amount of conspecific pollen deposited in stigmas when flowers are open to animal pollinators than what is deposited due to self-pollination. 
