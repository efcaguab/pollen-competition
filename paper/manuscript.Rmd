...
The most obvious ecological factor influencing the cost of sharing pollinators is the species degree---the number of interaction partners. 
The extent to which species degree affects the benefit is called mutualistic trade-off. 
This trade-off is fundamental to the way we model and mathematically represent mutualistic systems because it considerably simplifies the mathematical treatment of competition for pollinators. 
Furthermore the mutualistic trade-off has been shown to play a determining role on the stability and diversity of mutualistic communities. 
Yet, empirical evidence of the trade-off at the community scale is scarce, to say the least. 

Although the relationship between degree and the costs of the pollination service is intuitive, elucidating the magnitude of the trade-off at the community scale has been elusive because multiple other factors like traits, abundance, and the share of the pollen pool lmight be involved.
...
Second, we investigate wether there is a relationship between this gain and the species degree, trait originality, abundance, and contribution to the pollen pool, which together describe the role of the plant species and the ecological context.  
