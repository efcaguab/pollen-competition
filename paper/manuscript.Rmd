...
Indeed, `r nrow(sp_both_pos_neg)` species  (*Cypella herbertii*, *Diplotaxis tenuifolia*, *Hirschfeldia incana*, and *Carduus acanthoides*) showed significantly positive relationships in some communities and negative in others. 
Furthermore, although neither a positive or negative was dominant, we found that, in almost all cases, more conspecific than heterospecific pollen was deposited on stigmas (Figure \@ref(fig:fig-trade-off-predictions)b). 
