...
Third, we found that the way these factors influence competition is strongly shaped by the community context. That is, if these factors collectively define a species' niche of competition for pollination,
...
Here we show that the coexistence of facilitative and competitive effects of animal-mediated pollination can be at least partially explained by the trade-offs plants have to face when simultaneously maximising the deposition of conspecific pollen and minimising that of heterospecific pollen in both the short and the long term.   
...
To ensure long-term survival, it is thus likely that plants also need to balance this risk with the costs of sharing pollinators. 
...
On the one hand, receiving high visitation increases conspecific pollen deposition but increases heterospecific pollen deposition to a greater extent---even when the visitors are likely to carry a high proportion of conspecific pollen [@fang_paradoxical_2016]. 
On the other hand, being abundant reduces the amount of heterospecific pollen deposited but this comes at the expense of a noticeable reduction in the amount of conspecific pollen. 
...
Importantly, we show here that the balances between costs and benefits are determined not only by species identity but also on the community plants belong to. 
...
Nevertheless, our results indicate that the strategies plant might use to successfully minimise competition for pollination must be determined relative to other species in the community, rather than an absolute property of the species itself. 
