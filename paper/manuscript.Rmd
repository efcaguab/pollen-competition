...
Multiple studies recognise the importance of visitation and abundance to competition for pollination, however, some suggest a positive effect on the pollination service while some others a negative one [@feldman_when_2004; @munoz_presence_2008; @morales_interspecific_2008]. 
Our results corroborate the importance of these two factors, and show that the contrsating results obtained by earlier studies could be explained by the trade-offs involved.

Simultaneously, because visitation, pollen production and abundance are correlated [@sargent_role_2006], the trade-offs also suggest that plants must reach a fine balance between increasing conspecific pollen and reduce heterospecific pollen deposition to minimise competition for pollination. 
