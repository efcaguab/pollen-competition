...
Although the overall relationship between between heterospecific and conspecific pollen was positive (Supp info Table XX), the number of species in their communities with a positive relationship was equal to the number with a negative relationship (`r if(equal_pos_neg) {counts_facilitation_slope$nn[1]} else {stop("unequal")}`, `r counts_facilitation_slope$np[3]`%). 
...
Indeed, *Cypella herbertii*, *Hirschfeldia incana*, and *Carduus acanthoides*, showed significantly positive relationships in some communities and negative in others. 
