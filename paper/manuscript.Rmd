...
Multiple factors (like the number of shared pollinators, the plants relative abundance, the visitator fidelity, and phenology and other traits) have been shown to modulate the strength of competition and in turn the fitness outcome [@bobisud_pollinator_1975; @mitchell_new_2009; @morales_interspecific_2008; @feinsinger_pollinationiscommunity_1987; @campbell_pollinator_1985]. 
It is currently clear that these neghative effects on fitness have the potential to drive the evolution of flower phenologies, morphologies and reproductive strategies, as well as driving ecological differentiation [@mitchell_new_2009]. 
With few exceptions [@rathcke_interactions_1988; @lopezaraizamikel_impact_2007], these findings are based on two-species systems, nevertheless, competitive interactions between species pairs do not occur in isolation. 
Instead, plants often occur in communities in which multiple competitive interactions operate simultaneously and lead to emergent phenomena not observed at smaller scales. 
