...
In contrast, a plants' relative abundance had a negative effect on the pollen deposition quantity, but the mean difference between the coefficients in the models indicates a positive association with the the purity (Figure \@ref(fig:fig-average-qual-quant)c). 
