...
Generally speaking, in the context of competition for pollination, we expect that a factor that increases the amount of conspecific pollen deposited in stigmas (both in absolute terms and relative to heterospecific pollen) also has a positive effect on the pollination service. 
