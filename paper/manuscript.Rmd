...
Further evidence of the complexity involved in achieving a balance between costs and benefits can be found when we examine the other two factors analysed in our models. 
For instance, the networks we studied represent only a snapshot of the community dynamics. 
While we show that being a specialist and sharing no pollinators might be preferable in the short term, over long periods of time there could be a risk associated to a plant having no pollinators. 
Hence, is likely that plants need to compensate this risk for the costs of sharing pollinators. 
One possible evolutionary strategt is having original traits as it’s commonly thought that species that are further from others in trait space suffer reduced competition. 
Yet, there are two possible caveats to this strategy that highlight the interrelatedness of the ecological factors. 
First, in a mutualism context, it is also possible that this could come at the cost of being less ‘apparent’ to pollinators. 
Second, the usuallly negative, relationship between trait originality and generalism has been shown to be dependent on abundance [@coux_linking_2016], with generalist being able to have original traits when they are abundant enough to proviude a valuable reward to make it worth to pollinators. 
Overall, competition for pollination niche a plant species occupies seems to be dictated by the trade-offs between 

The two other factors we analysed, did not exhibit a pollination trade-off: functional originallity was generally benefitial, while sharing pollinators was generally detrimental to pollen deposition.
Somewhat surprisingly, these two factors had considerably lower explanatory power in the models of pollen deposition when compared to visits and abundance. 
This does not necessarily imply that these variables are unimportant to competition for pollination. 
Instead, it is possible that the processes that underlay these strategies might be more complex than what our study was able to capture. 


Yet again, the interelatedness of the ecological factors and the fine balance between conspecific and heterospecific pollen is highlighted as @coux_linking_2016 showed that plants can be generalists *and* have original traits only when they are abundant 

This apparency problem could be overcome if you’re abundant and provide a valuable enough reward to make it worth pollinators while to develop a search image for you.




The relatively broad distribution of coefficients in our models might be explained by the large variation of the extent to which plant species are affected by pollen deposition. 
Indeed, some plant species experience a large reduction in seed set due to heterospecific pollen deposition, while others are relatively insensitive to heterospecific pollen but greatly affected by low levels of conspecific pollen deposition [@campbell_mechanism_1985]. 

<!-- The two other factors we analysed, functional originality and the number of involved a smaller trade-off than the abundance or visit efficacy.  -->
