...
At a pairwise level, pollination is underpinned by a delicate balance between the mutualistic relationship between plants and pollinators. 
...
These indirect connections can dramatically alter the quality of the pollination service that plants receive because they determine how conspecific and heterospecific pollen is transferend across the community. 
However, due to the large number of factors that operate at the community level, we do not understand how sharing pollinators affects the pollination service beyond systems with more than a handful of species. 
