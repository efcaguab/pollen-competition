...
The first, is by reducing the number of conspecific pollen grains on stigmas. 
For example, plants with distinctively attractive flowers might reduce the number of visits---and hence the amount of *conspecific* pollen deposited by animals---to those less attractive neighbouring plants [@yang_pollinator_2011]. 
