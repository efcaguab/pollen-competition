...
```{r fig-deposition-logtransformed-or-not, fig.height = 2.5, fig.cap = "Distribution of stigmatic pollen density plotted in (A) a linear scale, and (B) a logarithmic scale (zero values not shown)."}
loadd(dep_frame, sites)
...
```{r fig-abundance-logtransformed-or-not, fig.height = 2.5, fig.cap = "Distribution of plant abundance as (A) raw counts of floral units across communities, and (B) after applying a data transformation in which the counts have been "}
